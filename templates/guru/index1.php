...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url_for('static', filename='assets/img/icon.ico') }}">
	...
	<link rel="stylesheet" type="text/css" href="{{ url_for('static', filename='assets/css/atlantis.min.css') }}">

	<!-- CSS Just for demo purpose, don't include it in your project -->
	<link rel="stylesheet" type="text/css" href="{{ url_for('static', filename='assets/css/demo.css') }}">
	...
	<div class="wrapper">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
                            ...
                            <ul class="nav nav-collapse">
                                    {% for dm in mengajar %}
                                    <li>
                                        <a href="{{ url_for('absen', pelajaran=dm['id_mengajar']) }}">
                                            <span class="sub-item">KELAS ({{ dm['nama_kelas']|upper }})</span>
                                        </a>
                                    </li>
                                    {% endfor %}
                                </ul>
							...
							<div class="collapse" id="rekapAbsen">
								<ul class="nav nav-collapse">
                                    {% for dm in mengajar %}
                                    <li>
                                        <a href="{{ url_for('rekap', pelajaran=dm['id_mengajar']) }}">
                                            <span class="sub-item">KELAS ({{ dm['nama_kelas']|upper }})</span>
                                        </a>
                                    </li>
                                    {% endfor %}
		...
		<footer class="footer">
				<div class="container">
                    ...
                    &copy; {{ current_year }} Absensi MTs Negeri Pati (<a href="index.php">Abid Taufiqur Rohman </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
